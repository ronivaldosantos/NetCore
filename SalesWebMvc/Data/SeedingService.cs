...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        // quando instanciar essa classe irá receber uma instância do context também
        public SeedingService(SalesWebMvcContext context)
        {
            _context = context;
        }

        //Operação responsável por popular base de dados
        public void Seed()
        {
            //Testa se já existe registros na base de dados. Se houver não fará nada.
